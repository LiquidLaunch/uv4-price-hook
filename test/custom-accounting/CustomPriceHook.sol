...
contract CustomPriceHook is BaseTestHooks {
    using Hooks for IHooks;
    using CurrencySettler for Currency;

    uint256 public constant PRICE_MULTIPLYER = 1;
        ...
        returns (Currency input, Currency output, uint256 amount)
    {
        ...
        amount = params.amountSpecified < 0 ? uint256(-params.amountSpecified) * PRICE_MULTIPLYER  : uint256(params.amountSpecified)  * PRICE_MULTIPLYER ;
    }
}
